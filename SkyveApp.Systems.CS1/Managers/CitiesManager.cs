...
public class CitiesManager : ICitiesManager
{
    ...
    public CitiesManager(ILogger logger, ILocationManager locationManager, IPlaysetManager profileManager, ISettings settings, IContentManager contentManager, IOUtil iOUtil, IModUtil modUtil)
    {
        _logger = logger;
