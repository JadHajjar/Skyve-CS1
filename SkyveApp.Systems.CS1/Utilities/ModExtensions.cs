...
{
	public static string CleanName(this IPackage package)
	{
	...
	public static string CleanName(this IPackage package, out List<(Color Color, string Text)> tags)
	{
		tags = new();
	...
	public static string GetVersionText(this string name)
	{
