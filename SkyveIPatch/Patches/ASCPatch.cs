...
namespace SkyveIPatch.Patches {
    ...
    using Inject = Injections.SkyveInjections.Injections;
    ...
    public class ASCPatch : IPatch {
        ...
        public AssemblyDefinition SubscriptionManagerPatch(AssemblyDefinition ASC)
        {
            ...
            if (sman2) {
                // this is for testing
                var method = asm.MainModule.GetMethod("SkyveInjections.SubscriptionManager.DoNothing");
                ...
                var method = asm.MainModule.GetMethod(
                    "SkyveInjections.SubscriptionManager.PostBootAction");
            ...
            {
                var method = asm.MainModule.GetMethod(
                    "SkyveInjections.SteamUtilities.RegisterEvents", true);
