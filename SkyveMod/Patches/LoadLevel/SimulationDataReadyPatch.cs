...
public static class SimulationDataReadyPatch
{
	...
	public static void SpecialInvoke(SimulationDataReadyHandler e)
	{
		...
		{
			var name = @delegate.Method.FullDescription();
	...
	static readonly MethodInfo mSpecialInvoke = typeof(SimulationDataReadyPatch).GetMethod(nameof(SpecialInvoke), true);
	static readonly MethodInfo m_Invoke = typeof(SimulationDataReadyHandler).GetMethod(nameof(SimulationDataReadyHandler.Invoke), true);
