...
public static class Log
{
	...
	{
		LogMain.Exception(ex, m, showInPanel);
	}

	public static void Called(params object[] args)
	{
		Info(ReflectionHelpers.CurrentMethod(2, args) + " called.", false);
	}

	public static void Succeeded()
	{
		Info(ReflectionHelpers.CurrentMethod(2) + " succeeded!", false);
	}
}
