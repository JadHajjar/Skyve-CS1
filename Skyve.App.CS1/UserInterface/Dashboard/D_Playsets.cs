...
internal class D_Playsets : IDashboardItem
{
	...
	{
		DrawSection(e, applyDrawing, ref preferredHeight, _playsetManager.CurrentPlayset.Name ?? string.Empty, _playsetManager.CurrentPlayset.GetIcon(), Locale.ActivePlayset);
